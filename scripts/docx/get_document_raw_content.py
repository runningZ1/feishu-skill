...
def get_document_raw_content(app_id: str, app_secret: str, document_id: str):
...
def main():
    parser = argparse.ArgumentParser(description="获取文档纯文本内容")
    ...
    result = get_document_raw_content(config.app_id, config.app_secret, args.document_id)
    if result:
